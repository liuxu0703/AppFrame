...
public abstract class FilePathGenerator {
    ...
    public static class LimitSizeFilePathGenerator extends FilePathGenerator {
         ...
         * @param maxSize
         */
        public LimitSizeFilePathGenerator(Context context, String filename, String suffix, long maxSize) {
            super(context, filename, suffix);
         ...
         * @param maxSize
         */
        public LimitSizeFilePathGenerator(String dir, String filename, String suffix, long maxSize) {
            super(dir, filename, suffix);
            this.maxSize = maxSize;
        }
