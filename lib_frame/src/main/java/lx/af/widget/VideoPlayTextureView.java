...
public class VideoPlayTextureView extends TextureView
    ...
    public VideoPlayTextureView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(VideoPlayTextureView.class.getName());
    }

    @Override
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        super.onInitializeAccessibilityNodeInfo(info);
        info.setClassName(VideoPlayTextureView.class.getName());
    }
