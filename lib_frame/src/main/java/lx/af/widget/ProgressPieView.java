...
public class ProgressPieView extends View {
    ...
    private static final int DEFAULT_PROGRESS_COLOR = Color.parseColor("#33b5e5");
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        int backgroundColor = a.getColor(R.styleable.ProgressPieView_ppvBackgroundColor, DEFAULT_BACKGROUND_COLOR);
        int progressColor = a.getColor(R.styleable.ProgressPieView_ppvProgressColor, DEFAULT_PROGRESS_COLOR);
        int strokeColor = a.getColor(R.styleable.ProgressPieView_ppvStrokeColor, DEFAULT_STROKE_COLOR);
