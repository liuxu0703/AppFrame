 ...
 * date: 16-5-22
 */
public class RatioWidthLinearLayout extends LinearLayout {

    private float mRatio;

    public RatioWidthLinearLayout(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        parseAttr(context, attrs);
    }

    public RatioWidthLinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        parseAttr(context, attrs);
    }

    public RatioWidthLinearLayout(Context context) {
        super(context);
    }
