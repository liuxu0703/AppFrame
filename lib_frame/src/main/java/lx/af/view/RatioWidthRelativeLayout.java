 ...
 * date: 16-1-7
 */
public class RatioWidthRelativeLayout extends RelativeLayout {

    private float mRatio;

    public RatioWidthRelativeLayout(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        parseAttr(context, attrs);
    }

    public RatioWidthRelativeLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        parseAttr(context, attrs);
    }

    public RatioWidthRelativeLayout(Context context) {
        super(context);
    }
