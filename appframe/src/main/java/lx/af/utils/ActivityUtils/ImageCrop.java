...
public class ImageCrop {
     ...
     */
    public static ImageCrop of(Uri source, Uri destination) {
        return new ImageCrop(source, destination);
    }

    private ImageCrop(Uri source, Uri destination) {
     ...
     * @param y Aspect Y
     */
    public ImageCrop withAspect(int x, int y) {
     ...
     */
    public ImageCrop withMaxSize(int width, int height) {
