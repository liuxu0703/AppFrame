...
public class ViewFlow extends AdapterView<Adapter>{
	...
	public void setISAutoFlow(Boolean isAuto){
		this.isAuto = isAuto;
		startAutoFlowTimer();
	}

	private void startAutoFlowTimer(){
		handler = new Handler(){
			@Override
			public void handleMessage(Message msg) {

                if(getCount() != 0){
					snapToScreen((getSelectedItemPosition()+1) % getCount());
                }else if(getChildCount() != 0){
                    snapToScreen((getSelectedItemPosition()+1) % getChildCount());
				}
...
//				}
	...
	private View setupChild(@NonNull View child, boolean addToEnd, boolean recycle) {
