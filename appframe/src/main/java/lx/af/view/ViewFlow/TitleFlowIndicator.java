...
public class TitleFlowIndicator extends TextView implements FlowIndicator {
	...
	public TitleFlowIndicator(Context context, AttributeSet attrs) {
		...
		TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ViewFlowTitleIndicator);

		String customTypeface = a.getString(R.styleable.ViewFlowTitleIndicator_customTypeface);
		// Retrieve the colors to be used for this view and apply them.
		int footerColor = a.getColor(R.styleable.ViewFlowTitleIndicator_footerColor, FOOTER_COLOR);
		footerLineHeight = a.getDimension(R.styleable.ViewFlowTitleIndicator_footerLineHeight, FOOTER_LINE_HEIGHT);
		footerTriangleHeight = a.getDimension(R.styleable.ViewFlowTitleIndicator_footerTriangleHeight, FOOTER_TRIANGLE_HEIGHT);
		int selectedColor = a.getColor(R.styleable.ViewFlowTitleIndicator_selectedColor, SELECTED_COLOR);
		boolean selectedBold = a.getBoolean(R.styleable.ViewFlowTitleIndicator_selectedBold, SELECTED_BOLD);
		int textColor = a.getColor(R.styleable.ViewFlowTitleIndicator_IndicatorTextColor, TEXT_COLOR);
		float textSize = a.getDimension(R.styleable.ViewFlowTitleIndicator_IndicatorTextSize, TEXT_SIZE);
		float selectedSize = a.getDimension(R.styleable.ViewFlowTitleIndicator_selectedSize, textSize);
		titlePadding = a.getDimension(R.styleable.ViewFlowTitleIndicator_titlePadding, TITLE_PADDING);
		clipPadding = a.getDimension(R.styleable.ViewFlowTitleIndicator_clipPadding, CLIP_PADDING);
