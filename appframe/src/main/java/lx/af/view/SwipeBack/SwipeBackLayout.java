...
import lx.af.R;
import lx.af.view.ScrollDetectors.ScrollDetectors;
...
public class SwipeBackLayout extends FrameLayout {
    ...
    public SwipeBackLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        setShadow(R.drawable.swipe_back_left_shadow, EDGE_LEFT);
        setShadow(R.drawable.swipe_back_right_shadow, EDGE_RIGHT);
